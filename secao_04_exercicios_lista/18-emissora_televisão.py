...
for votosAtleta in votosAtletas:
    if (votosAtleta > 0):
        print(f'{contador}           \           {votosAtleta}           \    {votosAtleta / float(totalVotos) * 100:.2f} ')
              
        if (votosAtleta > votosAtletas[melhorJogador]):
            melhorJogador = contador - 1
    contador += 1

print(f'\nO melhor jogador foi o numero {melhorJogador + 1}, com { votosAtletas[melhorJogador]} votos, correspondendo a {votosAtletas[melhorJogador] / float(totalVotos) * 100:.2f} do total de votos.')
